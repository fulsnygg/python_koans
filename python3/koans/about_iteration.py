...
class AboutIteration(Koan):
    ...
    def test_just_return_first_item_found(self):
        ...
        self.assertEqual(filter, iterator.__class__)
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        result3 = functools.reduce(self.multiply, [3, 3, 3])
        self.assertEqual(27, result3)
    ...
    def test_all_iteration_methods_work_on_any_sequence_not_just_lists(self):
        ...
        try:
            ...
            try:
                ...
                self.assertEqual(list, file.readlines().__class__)
                self.assertEqual(map, iter(upcase_lines).__class__)
                #self.assertEqual(__, iter(file.readlines()).__class__)
                # gives <class 'list_iterator'> ?
            finally:
                # Arg, this is ugly.
